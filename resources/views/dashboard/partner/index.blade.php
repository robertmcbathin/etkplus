...
<div class="wrapper">
  ...
  <div class="text-center">
    ...
    <div class="dropup">
        <button href="#" class="btn btn-block btn-danger dropdown-toggle btn-square btn-fill" data-toggle="dropdown" aria-expanded="false">
          Редактировать
          <b class="caret"></b>
      </button>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form action="{{ route('dashboard.partner.edit_partner.post') }}" method="POST">
                    {{ csrf_field() }}
                    <input type="hidden" name="partner_id" value="{{ $partner->id }}">
                    <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
...
<div class="modal fade" id="edit-background-partner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form action="{{ route('dashboard.partner.edit_partner_background.post') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="partner_id" value="{{ $partner->id }}">
                    <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
...
<div class="modal fade" id="edit-logo-partner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                <form action="{{ route('dashboard.partner.edit_partner_logo.post') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    <input type="hidden" name="partner_id" value="{{ $partner->id }}">
                    <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
                        ...
                        <table class="table table-shopping">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="td-product">
                                        <form action="{{ route('dashboard.partner.edit-gallery-item.post') }}" method="POST">
                                          {{ csrf_field() }}
                                          <input type="hidden" name="partner_id" value="{{ $partner->id }}">
                                          <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                                    ...
                                    <form action="{{ route('dashboard.partner.delete-gallery-item.post') }}" method="POST">
                                      {{ csrf_field() }}
                                      <input type="hidden" name="partner_id" value="{{ $partner->id }}">
                                      <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                                      <input type="hidden" name="gallery_item_id" value="{{ $gallery_item->id }}">
          ...
          <div class="col-md-10 col-md-offset-1">
            ...
            <form action="{{ route('dashboard.partner.load-gallery.post') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <input type="hidden" name="partner_id" value="{{ $partner->id }}">
                <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            ...
                            <form action="{{ route('dashboard.partner.delete-partner-address.post') }}" method="POST">
                                {{ csrf_field() }}
                ...
                <div class="col-md-12">
                    <div class="card">
                        <form method="POST" action="{{ route('dashboard.partner.add-partner-address.post') }}">
                            {{ csrf_field() }}
                            <input type="hidden" name="partner_id" value="{{ $partner->id }}">
                            <div class="card-header">
                                <h4 class="card-title">
                    ...
                    <div class="card">
                        <form method="POST" action="{{ route('dashboard.add-partner-discount.post') }}">
                            ...
                            <div class="card-content">
                                ...
                                <button type="submit" class="btn btn-fill btn-success btn-square btn-fw">Добавить</button>
                            </div>
                        </form>
                    </div>
                </div>
