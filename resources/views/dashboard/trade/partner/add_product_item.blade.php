            ...
            <div class="container-fluid">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="card card-wizard" id="wizardCard">
                        <form id="wizardForm" method="POST" action="{{ route('dashboard.partner.shop.add-product.post') }}" novalidate="novalidate" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
                            <div class="card-header text-center">
                                <h4 class="card-title">Мастер создания товара</h4>
                                <p class="category">Он поможет Вам создать товарную позицию в каталоге</p>
                            </div>
                            <div class="card-content">
                                <ul class="nav nav-pills">
                                    ...
                                    <li style="width: 33.3333%;"><a href="#tab3" data-toggle="tab">Дополнительная информация</a></li>
                                </ul>
