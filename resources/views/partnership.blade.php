            ...
            <div class="row">
                <div class="col-md-4">
                   <div class="info">
                        ...
                        <div class="description">
                            <h4 class="info-title"> Огромное сообщество пользователей </h4>
                            <p>Более 120 000 человек пользуются нашими картами <b>каждый</b> день</p>
                        </div>
                   </div>
                </div>
                ...
                <div class="col-md-4">
                   <div class="info">
                        ...
                        <div class="description">
                            <h4 class="info-title"> Гибкий подход к клиентам </h4>
                            <p>Назначайте скидки, начисляйте и списывайте бонусы!</p>
                        </div>
                   </div>
                </div>
                ...
                <div class="col-md-4">
                   <div class="info">
                        ...
                        <div class="description">
                            <h4 class="info-title"> CRM-система </h4>
                            <p>Управляйте email-рассылками, поощряйте клиентов!</p>
                        </div>
                   </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-4 ml-auto mr-auto">
                <div class="container basic-container">
                    ...
                    <h6 class="category">Управление системой лояльности из любого места</h6>
                    <h5 class="description">Вы можете использовать панель управления для быстрого редактирования скидок, начисления бонусов клиентам и многого другого</h5>
                </div>
            </div>
        </div>
    </div>
<div class="section section-cards section-orange">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="section-description">
                        ...
                        <h5 class="description white-text">Больше никакого ведения базы клиентов в тетради! Если у Вас есть смартфон с функцией NFC, то управление лояльностью осуществляется быстро и легко! Но даже если такого под рукой нет, то и обычный смартфон на Android подойдет!</h5>
                    </div>
                </div>
            </div>
        </div>
        <section class="section-intro ">
            <div class="isolayer isolayer--deco1 isolayer--shadow " style="transform-style: preserve-3d; transform: translateX(33vw) translateY(-340px) rotateX(45deg) rotateZ(45deg);">
        ...
        <div class="section section-content section-gray">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 ">
                        <div class="section-description">
                            <h3 class="title">Стратегия продаж</h3>
                            <h6 class="category">Создайте свою дополнительную клиентскую базу</h6>
                            <h5 class="description">Наращивайте базу клиентов по картам, создавайте рассылки, создавайте интересные предложения для них! </h5>
                        </div>
                    </div>
                </div>
            </div>
