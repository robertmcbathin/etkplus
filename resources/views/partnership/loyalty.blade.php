                ...
                <div class="row">
                    ...
                    <div class="col-md-4 ">
                        <div class="section-description">
                            ...
                            <h5 class="description">Наращивайте базу клиентов по картам, создавайте рассылки и интересные предложения для них! </h5>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card card-pricing" data-background="image" style="background-image: url('assets/img/pages/partnership/price1.jpg')">
                            <div class="card-body">
                                ...
                                <ul>
                                    ...
                                    <li class="white-text"><b>5%</b> комиссия за операцию</li>
